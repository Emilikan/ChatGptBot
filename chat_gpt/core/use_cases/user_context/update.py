...
from chat_gpt.core.dto import UserContextUpdate, UserContextGetByFilters


class UserContextUpdateUseCase(UseCase[UserContextUpdate, None]):
    def __init__(
        self,
    ...
    async def execute(self, data: UserContextUpdate) -> None:
        ...
        user_context.context = data.context
